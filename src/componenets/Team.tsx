  ...
  return (
    <div className="bg-midnight-blue rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center text-center">
      ...
      <ul className="flex justify-center space-x-4">
        <li>
          <a href={linkedIn} target="_blank" className="text-electric-blue hover:text-neon-purple transition-colors duration-300">
        ...
        <li>
          <a href={github} target="_blank" className="text-electric-blue hover:text-neon-purple transition-colors duration-300">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fillRule="evenodd"
        ...
        <li>
          <a href={twitter} target="_blank" className="text-electric-blue hover:text-neon-purple transition-colors duration-300">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fillRule="evenodd"
